...
│   ├── <结构化目录> 
│   └── index.md (首页)
├── vuepress-theme-vdoing (可选，本地的vdoing主题)
...
* `docs/index.md` 首页
* `vuepress-theme-vdoing` 存放在本地的vdoing主题文件，如果你想深度的修改主题，可以在`docs/.vuepress/config.js`修改使用的主题指向这个文件。需要注意的是主题的后续维护升级只对npm主题包负责。
